...
def create_test_data(spark, config):
    ...
    (df
     .coalesce(1)
     .write
     .parquet('tests/domain/system/test_unit/test_data/employees', mode='overwrite'))
    ...
    (df_tf
     .coalesce(1)
     .write
     .parquet('tests/domain/system/test_unit/test_data/employees_report', mode='overwrite'))
